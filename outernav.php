...
<nav class="navbar navbar-expand-lg navbar-light bg-light" style="background-color:#666666 !important">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown" style="float:right; font-weight:bold; color:#FFFFFF !important; position:absolute; right:10px;">
            <ul class="navbar-nav">
                 <li class="nav-item">
                    <a class="nav-link" href="http://localhost/blockchain_new/blockchain/index.php" id="navbarDropdownMenuLink" role="button"
                        data-bs-toggle="dropdown" aria-expanded="false" style="color:#FFFFFF !important;">
                        Home
                    </a>
                </li>
				<li class="nav-item">
                    <a class="nav-link" href="http://localhost/blockchain_new/blockchain/pages/about-us.php" id="navbarDropdownMenuLink" role="button"
                        data-bs-toggle="dropdown" aria-expanded="false" style="color:#FFFFFF !important;">
                        About Blockchain Voting System
                    </a>
                </li>
				<li class="nav-item">
                    <a class="nav-link" href="http://localhost/blockchain_new/blockchain/pages/contact-us.php" id="navbarDropdownMenuLink" role="button"
                        data-bs-toggle="dropdown" aria-expanded="false" style="color:#FFFFFF !important;">
                       Contact Us
                    </a>
                </li>
